...
firebase.database().ref('atractivos').once('value', (data) => {
  ...
  for (var i =0; i< keys.length; i++){
    ...
    global.apartado_coloniales = [datos[k].name];
    var subkeys= Object.keys(lugares);
    global.f_coloniales =[];
    //global.myVar = apartado_coloniales;
    for(var m=0; m< subkeys.length; m++){
      f_coloniales.push(subkeys[m].toString()); 
    }
    //global.f = [subkeys[0],subkeys[1],subkeys[2],subkeys[3],subkeys[4]];
    
    global.desc_coloniales =[];
    global.link_imagen_coloniales=[];
    for(var k=0; k< subkeys.length; k++){
      var fotos = lugares[f_coloniales[k]].fotos;
      desc_coloniales.push(lugares[f_coloniales[k]].desc);
      //global.desc_coloniales = lugares[f[k]].desc_coloniales;
      var keylinks = Object.keys(fotos);
      var links = keylinks[0];
      link_imagen_coloniales.push(fotos[links])
      //global.link_imagen_coloniales =fotos[links];
    }
    ...
    console.log('-----',link_imagen_coloniales);
    console.log('-----',apartado_coloniales);
    console.log('-----',f_coloniales);
    console.log('-----',desc_coloniales);
...
export default class Buceo extends React.Component {
  ...
  showAlert=(indice) => {
    ...
    //alert(desc_coloniales);
    console.log('cabeza de naranja');
    Alert.alert(
      //title
      //'Informacion',
      f_coloniales[indice].toUpperCase(),
      //body
      'Descripcion: '+desc_coloniales[indice],
      [
  ...
  render() {
    ...
    return (
      ...
      >
        {apartado_coloniales.toString().toUpperCase()}
      </Text>
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[0] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[1] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[2] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[3] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[4] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[5] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[6] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: link_imagen_coloniales[7] }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
...
<ImageBackground 
  source={{ uri: 'https://honduras.travel/images/carousel/ciudades-coloniales/carousel-santa-barbara-1.jpg' }}
  style={{flexGrow: 1, width: 'auto', height: 350, justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}
>
  <Text 
    style={{
